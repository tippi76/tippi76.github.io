$(document).ready(function() {
  ...
  function mainLoop() {
    ...
    // ctx.fillText("Salony Gupta", w/2-80, 216);
  }
  ...
  function UpdatePosition () {
    var bodyWidth = document.documentElement.clientWidth,
        bodyHeight = document.getElementById('rain').offsetHeight;
  ...
  function sidewalk()
  {
    ...
    ctx.fillStyle = '#343A34';
    ctx.fillRect(0,445,w,10);
    grd = ctx.createRadialGradient(250, 435, 0,
                                       215, 500, 150);
